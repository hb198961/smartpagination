...
<head>
	<title>SmartPagination——简单查询[iBATIS]</title>
</head>
		...
		<tr valign="top"><td align="left">
			<table width="50%" border="1" cellpadding="1" cellspacing="0" align="center">
				...
				<tr>
					...
					<td>
						<paging:hdivPagehead  align="center" url="/listIbatis.htm" orderBy="email" >email</paging:hdivPagehead>
					</td>	
					<td>
						<paging:hdivPagehead align="center" url="/listIbatis.htm" orderBy="birth" >birth</paging:hdivPagehead>
					</td>
					<td>
						<paging:hdivPagehead align="center" url="/listIbatis.htm" orderBy="sex" >sex</paging:hdivPagehead>
					</td>
				</tr>
				...
				<tr>
					<td colspan="5"><paging:hdivPagebar url="/listIbatis.htm" styleClass="pagebar" /></td>
				</tr>
				</c:if>
				<tr>
